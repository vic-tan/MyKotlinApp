 ...
 */
open class LoginTestAtivity : BaseActivity<ActivityLoginBinding, LoginTestViewModel>(),
    TextWatcher {
    ...
    companion object {
        fun actionStart() {
            startActivity<LoginTestAtivity> { }
            ActivityUtils.finishOtherActivities(LoginTestAtivity::class.java)
        }
    }
    ...
    private fun initViewModelObserve() {
        ...
        mViewModel.mSmsCodeInterval.observe(this, Observer {
            when (it) {
                EnumConst.TimerConst.START.value -> onIntervalStart()
                EnumConst.TimerConst.COMPLETE.value -> onIntervalComplete()
